...
DSPY_TEMPERATURE ?=
DSPY_MAX_TOKENS ?=
export DSPY_HELPER_MODEL ?= azure/gpt-5.4-nano
export DSPY_HELPER_API_KEY ?=
export DSPY_HELPER_API_BASE ?=
export DSPY_HELPER_API_VERSION ?=
export DSPY_HELPER_MODEL_TYPE ?= chat
export DSPY_HELPER_TEMPERATURE ?=
export DSPY_HELPER_MAX_TOKENS ?=
export DSPY_TRAINER_MODEL ?= azure/gpt-5.4-mini
export DSPY_TRAINER_API_KEY ?=
export DSPY_TRAINER_API_BASE ?=
export DSPY_TRAINER_API_VERSION ?=
export DSPY_TRAINER_MODEL_TYPE ?= chat
export DSPY_TRAINER_TEMPERATURE ?=
export DSPY_TRAINER_MAX_TOKENS ?=
DSPY_PROGRAM_PATH ?=
