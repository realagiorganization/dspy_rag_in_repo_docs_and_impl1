...
| `docs/architecture/research-narrative.md` | docs | markdown | 506 | 37523 | Repository research narrative tying code, docs, and verification together |
...
| `docs/audit/2026-05-02-zz-codex-exec-resume-session-state-stage0.md` | docs | markdown | 1018 | 49319 | Repository audit note for 2026 05 02 zz codex exec resume session state stage0 |
...
| `docs/planning/dataset-integration-plan.md` | docs | markdown | 392 | 27869 | Dataset Integration Plan |
...
| `src/repo_rag_lab/cli.py` | src | python | 1331 | 58263 | Command-line entrypoints for the shared repository RAG workflows. |
| `src/repo_rag_lab/codex_proxy.py` | src | python | 965 | 34195 | Local streaming proxy that injects repo-RAG + DSPy mediation for Codex. |
| `src/repo_rag_lab/corpus.py` | src | python | 112 | 2866 | Repository file loading helpers for the baseline text corpus. |
...
| `src/repo_rag_lab/mcp_server.py` | src | python | 424 | 15861 | Minimal stdio MCP server for bounded repo-RAG operations. |
...
| `tests/test_codex_proxy.py` | tests | python | 344 | 12184 | Python module for test codex proxy |
