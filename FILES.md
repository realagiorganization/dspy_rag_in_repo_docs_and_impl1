...
| `README.md` | README.md | markdown | 179 | 11618 | Top-level repository overview, workflow map, and quality guidance |
...
| `documentation/simple-end-to-end-verification-guide.md` | documentation | markdown | 105 | 4111 | Simple End-To-End Verification Guide |
| `env.md` | env.md | markdown | 108 | 5043 | Environment Variables |
| `mkdocs.yml` | mkdocs.yml | yaml | 37 | 843 | site_name: Repository RAG Lab |
| `notebooks/01_repo_rag_research.ipynb` | notebooks | notebook | 281 | 9320 | Repository RAG Research Playbook |
...
| `publication/exploratorium_translation/exploratorium_translation.pdf` | publication | binary |  | 536889 | Binary tracked asset at publication/exploratorium_translation/exploratorium_translation.pdf |
| `publication/exploratorium_translation/exploratorium_translation.tex` | publication | latex | 70 | 2573 | \documentclass[11pt]{article} |
| `publication/exploratorium_translation/generated/exploratorium-content.tex` | publication | latex | 1803 | 561971 | % Generated by repo-rag sync-exploratorium-translation. Do not edit manually. |
| `publication/exploratorium_translation/generated/exploratorium-manifest.json` | publication | json | 3243 | 221102 | JSON object with keys: generated_at, tracked_file_count, summarized_file_count |
| `publication/references.bib` | publication | bibtex | 28 | 1252 | @inproceedings{lewis2020rag, |
| `publication/repository-rag-lab-article.pdf` | publication | binary |  | 235632 | Binary tracked asset at publication/repository-rag-lab-article.pdf |
...
| `pyproject.toml` | pyproject.toml | toml | 94 | 2115 | [build-system] |
...
| `src/repo_rag_lab/benchmarks.py` | src | python | 459 | 15639 | Retrieval benchmark helpers for notebook assertions and logging. |
| `src/repo_rag_lab/cli.py` | src | python | 347 | 12693 | Command-line entrypoints for the shared repository RAG workflows. |
...
| `src/repo_rag_lab/exploratorium_translation.py` | src | python | 1009 | 37989 | Generate the bilingual exploratorium translation publication surfaces. |
| `src/repo_rag_lab/file_summaries.py` | src | python | 323 | 10214 | Generate tracked repository file-summary surfaces. |
...
| `src/repo_rag_lab/pages_site.py` | src | python | 390 | 13593 | Generate a MkDocs-ready catalog of tracked repository Markdown files. |
...
| `src/repo_rag_lab/utilities.py` | src | python | 274 | 10143 | User-facing utility helpers shared by the CLI, tests, and notebooks. |
| `src/repo_rag_lab/verification.py` | src | python | 147 | 4126 | Verification helpers for Makefile and notebook contract checks. |
...
| `tests/fixtures/hushwheel_lexiconarium/docs/hushwheel-reference.pdf` | tests | binary |  | 1753616 | Binary tracked asset at tests/fixtures/hushwheel_lexiconarium/docs/hushwheel-reference.pdf |
...
| `tests/test_benchmarks_and_notebook_scaffolding.py` | tests | python | 270 | 11456 | Python module for test benchmarks and notebook scaffolding |
| `tests/test_cli_and_dspy.py` | tests | python | 554 | 19512 | Python module for test cli and dspy |
| `tests/test_dspy_training.py` | tests | python | 493 | 17531 | Python module for test dspy training |
| `tests/test_exploratorium_translation.py` | tests | python | 137 | 5212 | Python module for test exploratorium translation |
...
| `tests/test_project_surfaces.py` | tests | python | 473 | 21050 | Python module for test project surfaces |
...
| `tests/test_utilities.py` | tests | python | 312 | 11045 | Python module for test utilities |
