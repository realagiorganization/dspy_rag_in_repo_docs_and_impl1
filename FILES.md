...
| `README.md` | README.md | markdown | 312 | 26042 | Top-level repository overview, workflow map, and quality guidance |
...
| `docs/architecture/research-narrative.md` | docs | markdown | 534 | 39942 | Repository research narrative tying code, docs, and verification together |
...
| `docs/audit/2026-05-02-zz-codex-exec-resume-session-state-stage0.md` | docs | markdown | 1740 | 81017 | Repository audit note for 2026 05 02 zz codex exec resume session state stage0 |
...
| `docs/planning/codex-exec-resume-plan.md` | docs | markdown | 195 | 10803 | Codex Exec Resume Plan |
| `docs/planning/dataset-integration-plan.md` | docs | markdown | 416 | 30048 | Dataset Integration Plan |
...
| `src/repo_rag_lab/mcp_server.py` | src | python | 514 | 19406 | Minimal stdio MCP server for bounded repo-RAG operations. |
...
| `tests/test_mcp_server.py` | tests | python | 485 | 15931 | Python module for test mcp server |
