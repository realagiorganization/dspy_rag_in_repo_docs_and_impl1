...
| `docs/architecture/dspy-rag-guide.md` | docs | markdown | 904 | 49703 | DSPy workflow guide for training, runtime use, and compiled programs |
...
| `src/repo_rag_lab/runtime_artifacts.py` | src | python | 2447 | 106775 | Versioned bundle, overlay, and runtime-trace helpers. |
...
| `src/repo_rag_lab/training_samples.py` | src | python | 2335 | 94604 | Helpers for loading and summarizing starter DSPy training examples. |
| `src/repo_rag_lab/utilities.py` | src | python | 2582 | 105181 | User-facing utility helpers shared by the CLI, tests, and notebooks. |
...
| `tests/test_runtime_artifacts_azure.py` | tests | python | 1389 | 52150 | Python module for test runtime artifacts azure |
...
| `tests/test_training_samples.py` | tests | python | 1870 | 72842 | Python module for test training samples |
| `tests/test_utilities.py` | tests | python | 2473 | 97012 | Python module for test utilities |
