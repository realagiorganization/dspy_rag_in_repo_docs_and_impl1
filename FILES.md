...
| `.github/workflows/hushwheel-quality.yml` | .github | yaml | 84 | 2684 | GitHub Actions workflow for hushwheel quality |
...
| `Makefile` | Makefile | makefile | 242 | 8646 | UV ?= uv |
...
| `docs/audit/2026-03-18-zzzzzzzzzzzzzzzzzzzzzzz-merge-hushwheel-quality-into-master.md` | docs | markdown | 97 | 3747 | Repository audit note for 2026 03 18 zzzzzzzzzzzzzzzzzzzzzzz merge hushwheel quality into master |
...
| `publication/exploratorium_translation/exploratorium_translation.pdf` | publication | binary |  | 465445 | Binary tracked asset at publication/exploratorium_translation/exploratorium_translation.pdf |
| `publication/exploratorium_translation/exploratorium_translation.tex` | publication | latex | 70 | 2573 | \documentclass[11pt]{article} |
| `publication/exploratorium_translation/generated/exploratorium-content.tex` | publication | latex | 1578 | 482177 | % Generated by repo-rag sync-exploratorium-translation. Do not edit manually. |
| `publication/exploratorium_translation/generated/exploratorium-manifest.json` | publication | json | 2805 | 190374 | JSON object with keys: generated_at, tracked_file_count, summarized_file_count |
...
| `tests/test_project_surfaces.py` | tests | python | 393 | 17024 | Python module for test project surfaces |
...
| `tests/test_utilities.py` | tests | python | 195 | 7029 | Python module for test utilities |
