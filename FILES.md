...
| `docs/architecture/dspy-rag-guide.md` | docs | markdown | 778 | 40922 | DSPy workflow guide for training, runtime use, and compiled programs |
...
| `docs/architecture/research-narrative.md` | docs | markdown | 373 | 25326 | Repository research narrative tying code, docs, and verification together |
...
| `docs/planning/dataset-integration-plan.md` | docs | markdown | 261 | 15730 | Dataset Integration Plan |
...
| `publication/exploratorium_translation/generated/exploratorium-content.tex` | publication | latex | 2083 | 653137 | % Generated by repo-rag sync-exploratorium-translation. Do not edit manually. |
| `publication/exploratorium_translation/generated/exploratorium-manifest.json` | publication | json | 3757 | 256556 | JSON object with keys: generated_at, tracked_file_count, summarized_file_count |
...
| `src/repo_rag_lab/utilities.py` | src | python | 2188 | 86120 | User-facing utility helpers shared by the CLI, tests, and notebooks. |
...
| `tests/test_utilities.py` | tests | python | 1516 | 59080 | Python module for test utilities |
