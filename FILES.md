...
| `docs/architecture/dspy-rag-guide.md` | docs | markdown | 801 | 42274 | DSPy workflow guide for training, runtime use, and compiled programs |
...
| `docs/architecture/research-narrative.md` | docs | markdown | 748 | 57140 | Repository research narrative tying code, docs, and verification together |
...
| `docs/audit/README.md` | docs | markdown | 14 | 427 | Repository audit note for README |
...
| `docs/planning/trainer-context-group-champion-plan.md` | docs | markdown | 114 | 7450 | Trainer Context-Group Champion Plan |
...
| `publication/exploratorium_translation/generated/exploratorium-content.tex` | publication | latex | 2308 | 732643 | % Generated by repo-rag sync-exploratorium-translation. Do not edit manually. |
| `publication/exploratorium_translation/generated/exploratorium-manifest.json` | publication | json | 4165 | 285820 | JSON object with keys: generated_at, tracked_file_count, summarized_file_count |
...
| `src/repo_rag_lab/azure_artifacts.py` | src | python | 415 | 15822 | Azure Blob + Queue helpers for trainer-side traces and global bundle storage. |
...
| `src/repo_rag_lab/codex_proxy.py` | src | python | 1350 | 50893 | Local streaming proxy that injects repo-RAG + DSPy mediation for Codex. |
| `src/repo_rag_lab/corpus.py` | src | python | 181 | 5245 | Repository file loading helpers for the baseline text corpus. |
| `src/repo_rag_lab/dspy_training.py` | src | python | 1000 | 36473 | DSPy training and artifact helpers for repository-grounded RAG. |
...
| `src/repo_rag_lab/mcp_server.py` | src | python | 1346 | 50006 | Minimal stdio MCP server for bounded repo-RAG operations. |
...
| `src/repo_rag_lab/retrieval.py` | src | python | 791 | 25563 | Baseline chunking and lexical retrieval utilities for repository text. |
...
| `src/repo_rag_lab/runtime_artifacts.py` | src | python | 1907 | 81152 | Versioned bundle, overlay, and runtime-trace helpers. |
...
| `src/repo_rag_lab/trainer_deployment.py` | src | python | 427 | 17783 | Kubernetes manifest helpers for trainer-side repo-RAG deployment surfaces. |
| `src/repo_rag_lab/training_samples.py` | src | python | 2168 | 85756 | Helpers for loading and summarizing starter DSPy training examples. |
| `src/repo_rag_lab/utilities.py` | src | python | 2544 | 103283 | User-facing utility helpers shared by the CLI, tests, and notebooks. |
...
| `tests/test_codex_proxy.py` | tests | python | 512 | 17520 | Python module for test codex proxy |
| `tests/test_dspy_training.py` | tests | python | 814 | 29596 | Python module for test dspy training |
...
| `tests/test_mcp_server.py` | tests | python | 786 | 26234 | Python module for test mcp server |
...
| `tests/test_runtime_artifacts_azure.py` | tests | python | 878 | 31440 | Python module for test runtime artifacts azure |
...
| `tests/test_training_samples.py` | tests | python | 1623 | 61597 | Python module for test training samples |
| `tests/test_utilities.py` | tests | python | 2418 | 94748 | Python module for test utilities |
