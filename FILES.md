...
| `docs/audit/README.md` | docs | markdown | 15 | 526 | Repository audit note for README |
...
| `src/repo_rag_lab/runtime_artifacts.py` | src | python | 3165 | 142445 | Versioned bundle, overlay, and runtime-trace helpers. |
...
| `src/repo_rag_lab/training_samples.py` | src | python | 3685 | 150461 | Helpers for loading and summarizing starter DSPy training examples. |
...
| `tests/test_runtime_artifacts_azure.py` | tests | python | 1701 | 65737 | Python module for test runtime artifacts azure |
...
| `tests/test_training_samples.py` | tests | python | 3160 | 125617 | Python module for test training samples |
