...
| `docs/architecture/research-narrative.md` | docs | markdown | 910 | 68390 | Repository research narrative tying code, docs, and verification together |
...
| `docs/audit/README.md` | docs | markdown | 14 | 420 | Repository audit note for README |
...
| `publication/exploratorium_translation/generated/exploratorium-content.tex` | publication | latex | 2338 | 742477 | % Generated by repo-rag sync-exploratorium-translation. Do not edit manually. |
| `publication/exploratorium_translation/generated/exploratorium-manifest.json` | publication | json | 4221 | 289867 | JSON object with keys: generated_at, tracked_file_count, summarized_file_count |
...
| `src/repo_rag_lab/codex_proxy.py` | src | python | 1586 | 61011 | Local streaming proxy that injects repo-RAG + DSPy mediation for Codex. |
...
| `src/repo_rag_lab/runtime_artifacts.py` | src | python | 2372 | 103601 | Versioned bundle, overlay, and runtime-trace helpers. |
...
| `tests/test_codex_proxy.py` | tests | python | 846 | 30213 | Python module for test codex proxy |
...
| `tests/test_runtime_artifacts_azure.py` | tests | python | 1224 | 46320 | Python module for test runtime artifacts azure |
