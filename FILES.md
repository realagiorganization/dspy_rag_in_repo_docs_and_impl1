...
| `.github/workflows/hushwheel-quality.yml` | .github | yaml | 102 | 3526 | GitHub Actions workflow for hushwheel quality |
| `.github/workflows/publication-pdf.yml` | .github | yaml | 142 | 5549 | GitHub Actions workflow for publication pdf |
...
| `Makefile` | Makefile | makefile | 248 | 8914 | UV ?= uv |
...
| `README.md` | README.md | markdown | 172 | 10943 | Top-level repository overview, workflow map, and quality guidance |
...
| `docs/audit/2026-03-19-github-pr-gate-sync.md` | docs | markdown | 88 | 3556 | Repository audit note for 2026 03 19 github pr gate sync |
...
| `publication/exploratorium_translation/exploratorium_translation.pdf` | publication | binary |  | 1733235 | Binary tracked asset at publication/exploratorium_translation/exploratorium_translation.pdf |
| `publication/exploratorium_translation/exploratorium_translation.tex` | publication | latex | 70 | 2573 | \documentclass[11pt]{article} |
| `publication/exploratorium_translation/generated/exploratorium-content.tex` | publication | latex | 1628 | 497727 | % Generated by repo-rag sync-exploratorium-translation. Do not edit manually. |
| `publication/exploratorium_translation/generated/exploratorium-manifest.json` | publication | json | 2895 | 196241 | JSON object with keys: generated_at, tracked_file_count, summarized_file_count |
...
| `src/repo_rag_lab/cli.py` | src | python | 329 | 12067 | Command-line entrypoints for the shared repository RAG workflows. |
...
| `src/repo_rag_lab/utilities.py` | src | python | 254 | 9590 | User-facing utility helpers shared by the CLI, tests, and notebooks. |
| `src/repo_rag_lab/verification.py` | src | python | 145 | 4089 | Verification helpers for Makefile and notebook contract checks. |
...
| `tests/test_cli_and_dspy.py` | tests | python | 529 | 18716 | Python module for test cli and dspy |
...
| `tests/test_project_surfaces.py` | tests | python | 417 | 18247 | Python module for test project surfaces |
...
| `tests/test_utilities.py` | tests | python | 240 | 8517 | Python module for test utilities |
