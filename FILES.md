...
| `Makefile` | Makefile | makefile | 520 | 24202 | UV ?= uv |
...
| `docs/architecture/research-narrative.md` | docs | markdown | 1112 | 84959 | Repository research narrative tying code, docs, and verification together |
...
| `publication/exploratorium_translation/generated/exploratorium-content.tex` | publication | latex | 2583 | 834347 | % Generated by repo-rag sync-exploratorium-translation. Do not edit manually. |
| `publication/exploratorium_translation/generated/exploratorium-manifest.json` | publication | json | 4664 | 323686 | JSON object with keys: generated_at, tracked_file_count, summarized_file_count |
...
| `src/repo_rag_lab/codex_proxy.py` | src | python | 1965 | 76047 | Local streaming proxy that injects repo-RAG + DSPy mediation for Codex. |
