...
| `docs/architecture/research-narrative.md` | docs | markdown | 1012 | 76621 | Repository research narrative tying code, docs, and verification together |
...
| `docs/audit/README.md` | docs | markdown | 14 | 439 | Repository audit note for README |
...
| `docs/planning/family-first-mipro-runtime-contract.md` | docs | markdown | 375 | 23880 | Family-First DSPy / MIPROv2 Contract |
...
| `src/repo_rag_lab/codex_proxy.py` | src | python | 1887 | 72378 | Local streaming proxy that injects repo-RAG + DSPy mediation for Codex. |
...
| `src/repo_rag_lab/training_samples.py` | src | python | 2442 | 99625 | Helpers for loading and summarizing starter DSPy training examples. |
...
| `tests/test_codex_proxy.py` | tests | python | 1250 | 44644 | Python module for test codex proxy |
...
| `tests/test_training_samples.py` | tests | python | 2150 | 84697 | Python module for test training samples |
