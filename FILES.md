...
| `docs/architecture/research-narrative.md` | docs | markdown | 554 | 41784 | Repository research narrative tying code, docs, and verification together |
...
| `docs/audit/2026-05-02-zz-codex-exec-resume-session-state-stage0.md` | docs | markdown | 2279 | 104012 | Repository audit note for 2026 05 02 zz codex exec resume session state stage0 |
...
| `docs/planning/codex-exec-resume-plan.md` | docs | markdown | 202 | 11120 | Codex Exec Resume Plan |
| `docs/planning/dataset-integration-plan.md` | docs | markdown | 434 | 31276 | Dataset Integration Plan |
...
| `src/repo_rag_lab/__init__.py` | src | python | 42 | 889 | Public package surface for the repository-grounded RAG lab. |
...
| `src/repo_rag_lab/cli.py` | src | python | 1333 | 58423 | Command-line entrypoints for the shared repository RAG workflows. |
| `src/repo_rag_lab/codex_proxy.py` | src | python | 1005 | 36111 | Local streaming proxy that injects repo-RAG + DSPy mediation for Codex. |
| `src/repo_rag_lab/corpus.py` | src | python | 183 | 5267 | Repository file loading helpers for the baseline text corpus. |
...
| `src/repo_rag_lab/mcp_server.py` | src | python | 1042 | 38417 | Minimal stdio MCP server for bounded repo-RAG operations. |
...
| `src/repo_rag_lab/runtime_artifacts.py` | src | python | 1729 | 72966 | Versioned bundle, overlay, and runtime-trace helpers. |
...
| `src/repo_rag_lab/trainer_deployment.py` | src | python | 431 | 17821 | Kubernetes manifest helpers for trainer-side repo-RAG deployment surfaces. |
| `src/repo_rag_lab/training_samples.py` | src | python | 1404 | 56311 | Helpers for loading and summarizing starter DSPy training examples. |
| `src/repo_rag_lab/utilities.py` | src | python | 2347 | 94299 | User-facing utility helpers shared by the CLI, tests, and notebooks. |
...
| `tests/test_cli_and_dspy.py` | tests | python | 1872 | 68435 | Python module for test cli and dspy |
| `tests/test_codex_proxy.py` | tests | python | 352 | 12532 | Python module for test codex proxy |
...
| `tests/test_mcp_server.py` | tests | python | 648 | 21490 | Python module for test mcp server |
...
| `tests/test_retrieval.py` | tests | python | 310 | 10471 | Python module for test retrieval |
| `tests/test_runtime_artifacts_azure.py` | tests | python | 849 | 30270 | Python module for test runtime artifacts azure |
...
| `tests/test_training_samples.py` | tests | python | 826 | 29935 | Python module for test training samples |
| `tests/test_utilities.py` | tests | python | 2137 | 84079 | Python module for test utilities |
