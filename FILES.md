...
| `docs/architecture/research-narrative.md` | docs | markdown | 392 | 27093 | Repository research narrative tying code, docs, and verification together |
...
| `docs/planning/dataset-integration-plan.md` | docs | markdown | 285 | 17874 | Dataset Integration Plan |
...
| `src/repo_rag_lab/dspy_training.py` | src | python | 884 | 32104 | DSPy training and artifact helpers for repository-grounded RAG. |
...
| `src/repo_rag_lab/training_samples.py` | src | python | 542 | 20459 | Helpers for loading and summarizing starter DSPy training examples. |
| `src/repo_rag_lab/utilities.py` | src | python | 2306 | 91583 | User-facing utility helpers shared by the CLI, tests, and notebooks. |
...
| `tests/test_utilities.py` | tests | python | 1870 | 73470 | Python module for test utilities |
