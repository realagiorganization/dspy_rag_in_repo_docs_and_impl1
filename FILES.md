...
| `README.md` | README.md | markdown | 305 | 25139 | Top-level repository overview, workflow map, and quality guidance |
| `TODO.MD` | TODO.MD | binary |  | 6104 | Binary tracked asset at TODO.MD |
| `config/retrieval-profile.json` | config | json | 66 | 1788 | JSON object with keys: name, retrieval_mode, rerank_candidate_pool_size |
...
| `docs/architecture/research-narrative.md` | docs | markdown | 386 | 26488 | Repository research narrative tying code, docs, and verification together |
...
| `docs/audit/README.md` | docs | markdown | 14 | 419 | Repository audit note for README |
...
| `docs/planning/dataset-integration-plan.md` | docs | markdown | 275 | 16993 | Dataset Integration Plan |
...
| `publication/exploratorium_translation/exploratorium_translation.pdf` | publication | binary |  | 592174 | Binary tracked asset at publication/exploratorium_translation/exploratorium_translation.pdf |
| `publication/exploratorium_translation/exploratorium_translation.tex` | publication | latex | 70 | 2573 | \documentclass[11pt]{article} |
| `publication/exploratorium_translation/generated/exploratorium-content.tex` | publication | latex | 2148 | 676964 | % Generated by repo-rag sync-exploratorium-translation. Do not edit manually. |
| `publication/exploratorium_translation/generated/exploratorium-manifest.json` | publication | json | 3875 | 265318 | JSON object with keys: generated_at, tracked_file_count, summarized_file_count |
...
| `src/repo_rag_lab/dspy_training.py` | src | python | 856 | 30978 | DSPy training and artifact helpers for repository-grounded RAG. |
...
| `src/repo_rag_lab/mcp_server.py` | src | python | 413 | 15371 | Minimal stdio MCP server for bounded repo-RAG operations. |
...
| `src/repo_rag_lab/retrieval.py` | src | python | 624 | 19924 | Baseline chunking and lexical retrieval utilities for repository text. |
| `src/repo_rag_lab/retrieval_profile.py` | src | python | 236 | 9500 | Profile-driven retrieval weighting, exclusions, and repo-local overrides. |
| `src/repo_rag_lab/runtime_artifacts.py` | src | python | 1453 | 61294 | Versioned bundle, overlay, and runtime-trace helpers. |
...
| `src/repo_rag_lab/training_samples.py` | src | python | 541 | 20395 | Helpers for loading and summarizing starter DSPy training examples. |
| `src/repo_rag_lab/utilities.py` | src | python | 2246 | 88590 | User-facing utility helpers shared by the CLI, tests, and notebooks. |
| `src/repo_rag_lab/verification.py` | src | python | 163 | 4476 | Verification helpers for Makefile and notebook contract checks. |
| `src/repo_rag_lab/workflow.py` | src | python | 466 | 14636 | Baseline repository question-answering workflow built on file retrieval. |
...
| `tests/test_dspy_training.py` | tests | python | 586 | 21115 | Python module for test dspy training |
...
| `tests/test_training_samples.py` | tests | python | 244 | 9188 | Python module for test training samples |
| `tests/test_utilities.py` | tests | python | 1757 | 68064 | Python module for test utilities |
...
| `tests/test_workflow_live.py` | tests | python | 106 | 3533 | Python module for test workflow live |
