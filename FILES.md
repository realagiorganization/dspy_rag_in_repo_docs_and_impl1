...
| `src/repo_rag_lab/runtime_artifacts.py` | src | python | 1614 | 68510 | Versioned bundle, overlay, and runtime-trace helpers. |
...
| `src/repo_rag_lab/trainer_deployment.py` | src | python | 415 | 17231 | Kubernetes manifest helpers for trainer-side repo-RAG deployment surfaces. |
| `src/repo_rag_lab/training_samples.py` | src | python | 589 | 22671 | Helpers for loading and summarizing starter DSPy training examples. |
| `src/repo_rag_lab/utilities.py` | src | python | 2305 | 91618 | User-facing utility helpers shared by the CLI, tests, and notebooks. |
...
| `tests/test_training_samples.py` | tests | python | 375 | 14458 | Python module for test training samples |
| `tests/test_utilities.py` | tests | python | 1870 | 73138 | Python module for test utilities |
