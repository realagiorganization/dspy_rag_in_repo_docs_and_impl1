...
| `Makefile` | Makefile | makefile | 520 | 24201 | UV ?= uv |
...
| `docs/architecture/dspy-rag-guide.md` | docs | markdown | 916 | 50547 | DSPy workflow guide for training, runtime use, and compiled programs |
...
| `docs/architecture/research-narrative.md` | docs | markdown | 1246 | 95506 | Repository research narrative tying code, docs, and verification together |
...
| `docs/audit/2026-05-16-queue-prompt-snapshot-mirroring.md` | docs | markdown | 60 | 2791 | Repository audit note for 2026 05 16 queue prompt snapshot mirroring |
...
| `docs/audit/README.md` | docs | markdown | 15 | 532 | Repository audit note for README |
...
| `docs/operations/trainer-deployment.md` | docs | markdown | 143 | 5773 | Trainer Deployment Notes |
...
| `publication/exploratorium_translation/exploratorium_translation.pdf` | publication | binary |  | 726076 | Binary tracked asset at publication/exploratorium_translation/exploratorium_translation.pdf |
| `publication/exploratorium_translation/exploratorium_translation.tex` | publication | latex | 70 | 2573 | \documentclass[11pt]{article} |
| `publication/exploratorium_translation/generated/exploratorium-content.tex` | publication | latex | 2593 | 837562 | % Generated by repo-rag sync-exploratorium-translation. Do not edit manually. |
| `publication/exploratorium_translation/generated/exploratorium-manifest.json` | publication | json | 4683 | 325076 | JSON object with keys: generated_at, tracked_file_count, summarized_file_count |
...
| `samples/training/repository_training_examples.yaml` | samples | yaml | 80 | 2504 | - question: What does this repository research? |
...
| `src/repo_rag_lab/codex_proxy.py` | src | python | 2274 | 90070 | Local streaming proxy that injects repo-RAG + DSPy mediation for Codex. |
| `src/repo_rag_lab/corpus.py` | src | python | 181 | 5245 | Repository file loading helpers for the baseline text corpus. |
| `src/repo_rag_lab/dspy_training.py` | src | python | 1889 | 71939 | DSPy training and artifact helpers for repository-grounded RAG. |
...
| `src/repo_rag_lab/runtime_artifacts.py` | src | python | 2866 | 128945 | Versioned bundle, overlay, and runtime-trace helpers. |
...
| `src/repo_rag_lab/trainer_deployment.py` | src | python | 435 | 18254 | Kubernetes manifest helpers for trainer-side repo-RAG deployment surfaces. |
| `src/repo_rag_lab/training_samples.py` | src | python | 3534 | 143924 | Helpers for loading and summarizing starter DSPy training examples. |
| `src/repo_rag_lab/utilities.py` | src | python | 3054 | 127329 | User-facing utility helpers shared by the CLI, tests, and notebooks. |
...
| `tests/test_cli_and_dspy.py` | tests | python | 1876 | 68616 | Python module for test cli and dspy |
| `tests/test_codex_proxy.py` | tests | python | 2265 | 84155 | Python module for test codex proxy |
...
| `tests/test_runtime_artifacts_azure.py` | tests | python | 1597 | 61587 | Python module for test runtime artifacts azure |
...
| `tests/test_training_samples.py` | tests | python | 2769 | 109127 | Python module for test training samples |
| `tests/test_utilities.py` | tests | python | 3469 | 134859 | Python module for test utilities |
