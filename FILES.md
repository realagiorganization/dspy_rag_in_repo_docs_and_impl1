...
| `docs/architecture/research-narrative.md` | docs | markdown | 1320 | 102140 | Repository research narrative tying code, docs, and verification together |
...
| `docs/audit/README.md` | docs | markdown | 15 | 511 | Repository audit note for README |
...
| `docs/planning/family-first-mipro-runtime-contract.md` | docs | markdown | 556 | 35913 | Family-First DSPy / MIPROv2 Contract |
...
| `src/repo_rag_lab/codex_proxy.py` | src | python | 2285 | 90466 | Local streaming proxy that injects repo-RAG + DSPy mediation for Codex. |
...
| `tests/test_codex_proxy.py` | tests | python | 2266 | 84170 | Python module for test codex proxy |
