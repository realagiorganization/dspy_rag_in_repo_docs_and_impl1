...
| `Makefile` | Makefile | makefile | 229 | 7562 | UV ?= uv |
| `README.AGENTS.md` | README.AGENTS.md | markdown | 243 | 13756 | Repository research narrative tying code, docs, and verification together |
| `README.DSPY.MD` | README.DSPY.MD | markdown | 648 | 30709 | DSPy workflow guide for training, runtime use, and compiled programs |
| `README.md` | README.md | markdown | 168 | 10367 | Top-level repository overview, workflow map, and quality guidance |
...
| `docs/audit/README.md` | docs | markdown | 14 | 426 | Audit index for dated repository verification notes |
...
| `src/repo_rag_lab/cli.py` | src | python | 297 | 10861 | Command-line entrypoints for the shared repository RAG workflows. |
...
| `src/repo_rag_lab/utilities.py` | src | python | 212 | 8062 | User-facing utility helpers shared by the CLI, tests, and notebooks. |
...
| `tests/test_utilities.py` | tests | python | 184 | 6650 | Python module for test utilities |
