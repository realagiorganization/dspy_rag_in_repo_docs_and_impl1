...
| `README.md` | README.md | markdown | 305 | 25223 | Top-level repository overview, workflow map, and quality guidance |
...
| `docs/architecture/research-narrative.md` | docs | markdown | 396 | 27400 | Repository research narrative tying code, docs, and verification together |
...
| `docs/planning/dataset-integration-plan.md` | docs | markdown | 288 | 18269 | Dataset Integration Plan |
