...
| `Makefile` | Makefile | makefile | 501 | 23539 | UV ?= uv |
| `README.md` | README.md | markdown | 304 | 24670 | Top-level repository overview, workflow map, and quality guidance |
...
| `docs/architecture/dspy-rag-guide.md` | docs | markdown | 768 | 40142 | DSPy workflow guide for training, runtime use, and compiled programs |
...
| `docs/architecture/package-api.md` | docs | markdown | 121 | 8700 | Package API Notes |
| `docs/architecture/research-narrative.md` | docs | markdown | 364 | 24338 | Repository research narrative tying code, docs, and verification together |
...
| `docs/operations/trainer-deployment.md` | docs | markdown | 137 | 5038 | Trainer Deployment Notes |
| `docs/planning/dataset-integration-plan.md` | docs | markdown | 245 | 14264 | Dataset Integration Plan |
...
| `publication/exploratorium_translation/generated/exploratorium-content.tex` | publication | latex | 2018 | 632127 | % Generated by repo-rag sync-exploratorium-translation. Do not edit manually. |
| `publication/exploratorium_translation/generated/exploratorium-manifest.json` | publication | json | 3636 | 247992 | JSON object with keys: generated_at, tracked_file_count, summarized_file_count |
...
| `src/repo_rag_lab/trainer_deployment.py` | src | python | 408 | 16564 | Kubernetes manifest helpers for trainer-side repo-RAG deployment surfaces. |
...
| `src/repo_rag_lab/utilities.py` | src | python | 2179 | 85465 | User-facing utility helpers shared by the CLI, tests, and notebooks. |
...
| `tests/test_cli_and_dspy.py` | tests | python | 1860 | 67652 | Python module for test cli and dspy |
...
| `tests/test_utilities.py` | tests | python | 1507 | 58397 | Python module for test utilities |
