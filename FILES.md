...
| `docs/architecture/research-narrative.md` | docs | markdown | 1022 | 77389 | Repository research narrative tying code, docs, and verification together |
...
| `docs/planning/family-first-mipro-runtime-contract.md` | docs | markdown | 387 | 24940 | Family-First DSPy / MIPROv2 Contract |
...
| `src/repo_rag_lab/runtime_artifacts.py` | src | python | 2487 | 108568 | Versioned bundle, overlay, and runtime-trace helpers. |
...
| `src/repo_rag_lab/utilities.py` | src | python | 2677 | 110796 | User-facing utility helpers shared by the CLI, tests, and notebooks. |
...
| `tests/test_runtime_artifacts_azure.py` | tests | python | 1467 | 55217 | Python module for test runtime artifacts azure |
...
| `tests/test_utilities.py` | tests | python | 2900 | 113180 | Python module for test utilities |
