...
| `docs/architecture/research-narrative.md` | docs | markdown | 436 | 31048 | Repository research narrative tying code, docs, and verification together |
...
| `docs/audit/README.md` | docs | markdown | 14 | 428 | Repository audit note for README |
...
| `docs/planning/dataset-integration-plan.md` | docs | markdown | 323 | 21603 | Dataset Integration Plan |
...
| `src/repo_rag_lab/runtime_artifacts.py` | src | python | 1699 | 71805 | Versioned bundle, overlay, and runtime-trace helpers. |
...
| `src/repo_rag_lab/utilities.py` | src | python | 2347 | 94094 | User-facing utility helpers shared by the CLI, tests, and notebooks. |
...
| `tests/test_runtime_artifacts_azure.py` | tests | python | 739 | 26693 | Python module for test runtime artifacts azure |
...
| `tests/test_utilities.py` | tests | python | 2025 | 79839 | Python module for test utilities |
