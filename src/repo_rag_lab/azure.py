...
def write_deployment_manifest(root: Path, model_id: str, deployment_name: str, endpoint: str) -> Path:
    ...
    manifest = {
        ...
        "notes": [
            ...
            "Use this deployment name as the model selector when calling the Azure inference endpoint.",
