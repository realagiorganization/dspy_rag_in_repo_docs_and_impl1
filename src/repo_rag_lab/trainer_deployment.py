...
DEFAULT_TRAINER_K8S_RECOMPILE_RUN_NAME: str | None = "trainer-auto"
...
def _config_map_payload(config: TrainerK8sConfig) -> dict[str, object]:
    data = {
        ...
        "DSPY_HELPER_MODEL_TYPE": "chat",
        "DSPY_HELPER_TEMPERATURE": "",
        "DSPY_HELPER_MAX_TOKENS": "",
        "DSPY_TRAINER_MODEL_TYPE": "chat",
        "DSPY_TRAINER_TEMPERATURE": "",
        "DSPY_TRAINER_MAX_TOKENS": "",
    }
    return {
        "apiVersion": "v1",
        "kind": "ConfigMap",
...
def _secret_example_payload(config: TrainerK8sConfig) -> dict[str, object]:
    return {
        ...
        "stringData": {
            ...
            "DSPY_HELPER_API_BASE": "https://<resource>.openai.azure.com",
            "DSPY_HELPER_API_VERSION": "<api-version>",
            "DSPY_HELPER_API_KEY": "<optional-helper-key-or-reuse-azure-key>",
            "DSPY_TRAINER_MODEL": "azure/gpt-5.4-mini",
            "DSPY_TRAINER_API_BASE": "https://<resource>.openai.azure.com",
            "DSPY_TRAINER_API_VERSION": "<api-version>",
            "DSPY_TRAINER_API_KEY": "<optional-trainer-key-or-reuse-azure-key>",
