...
def _secret_example_payload(config: TrainerK8sConfig) -> dict[str, object]:
    return {
        ...
        "stringData": {
            ...
            "DSPY_MODEL": "azure/<helper-deployment>",
            "DSPY_API_BASE": "https://<resource>.openai.azure.com",
            "DSPY_API_VERSION": "<api-version>",
            "DSPY_API_KEY": "<optional-helper-key-or-reuse-azure-key>",
