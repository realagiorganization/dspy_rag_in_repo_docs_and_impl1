...
def build_parser() -> argparse.ArgumentParser:
    ...
    serve_codex_proxy_parser.add_argument("--token-budget", type=int, default=420)
    serve_codex_proxy_parser.add_argument("--trivial-token-budget", type=int, default=180)
    serve_codex_proxy_parser.add_argument("--essentials-count", type=int, default=2)
    serve_codex_proxy_parser.add_argument("--low-signal-min-sources", type=int, default=1)
    serve_codex_proxy_parser.add_argument("--family-exploration-rate", type=float, default=0.05)
